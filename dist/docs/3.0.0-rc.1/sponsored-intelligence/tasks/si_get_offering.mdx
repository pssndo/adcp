...
```json
{
  "$schema": "/schemas/3.0.0-rc.1/sponsored-intelligence/si-get-offering-request.json",
...
```json
{
  "$schema": "/schemas/3.0.0-rc.1/sponsored-intelligence/si-get-offering-response.json",
  "available": true,
