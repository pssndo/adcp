...
| `assets`      | object   | Yes      | Assets keyed by role (e.g., `{video: {...}, thumbnail: {...}}`). Catalogs are included as assets with `asset_type: "catalog"`. See [Catalogs](/dist/docs/3.0.0-rc.1/creative/catalogs). |
...
Use the creative agent to generate creatives from brand identity data. See the [Generative Creatives guide](/dist/docs/3.0.0-rc.1/creative/generative-creative) for complete workflow details.
...
**See:** [Webhooks](/dist/docs/3.0.0-rc.1/building/implementation/webhooks) for webhook configuration.
...
- [list_creative_formats](/dist/docs/3.0.0-rc.1/media-buy/task-reference/list_creative_formats) - Check supported formats before upload
- [Generative Creatives Guide](/dist/docs/3.0.0-rc.1/creative/generative-creative) - Generate creatives from brand identity
- [get_media_buy_delivery](/dist/docs/3.0.0-rc.1/media-buy/task-reference/get_media_buy_delivery) - Monitor creative performance
- [Creative Asset Types](/dist/docs/3.0.0-rc.1/creative/asset-types) - Technical requirements for assets
