...
### 2. Discover Products  
Use [`get_products`](/dist/docs/3.0.0-rc.1/media-buy/task-reference/get_products) to find matching inventory based on your brief and brand.
...
Use `buying_mode: "refine"` with the `refine` array of change requests to iterate on products and proposals — include, omit, or find similar products, and request adjustments to proposals before committing to a buy. See [Refinement](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/refinement).

### 5. Work with Proposals
Publishers may return **proposals** alongside products—structured media plans with budget allocations that can be executed directly. See [Proposals](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/media-products#proposals).
...
Learn more in [Brief Expectations](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/brief-expectations).
...
2. **Use [`list_creative_formats`](/dist/docs/3.0.0-rc.1/media-buy/task-reference/list_creative_formats)** to get detailed format requirements
...
Explore comprehensive examples in [Example Briefs](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/example-briefs).
...
- [Refine](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/refinement) specific products with the `refine` array before committing
...
- **[`get_products`](/dist/docs/3.0.0-rc.1/media-buy/task-reference/get_products)**: ~60 seconds (AI processing)
- **[`list_creative_formats`](/dist/docs/3.0.0-rc.1/media-buy/task-reference/list_creative_formats)**: ~1 second (database lookup)

## Next Steps

After discovering products:
1. **[Create Media Buy](/dist/docs/3.0.0-rc.1/media-buy/media-buys/)** - Build campaigns from selected products
2. **[Creative Planning](/dist/docs/3.0.0-rc.1/media-buy/creatives/)** - Prepare assets matching format requirements
3. **[Task Reference](/dist/docs/3.0.0-rc.1/media-buy/task-reference/)** - Detailed API documentation for implementation

## Related Documentation

- **[Brief Expectations](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/brief-expectations)** - Comprehensive guide to brief structure
- **[Example Briefs](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/example-briefs)** - Real-world campaign brief patterns
- **[Media Products](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/media-products)** - Understanding product model and attributes
- **[Refinement](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/refinement)** - Iterating on products and proposals with change requests
- **[Proposals](/dist/docs/3.0.0-rc.1/media-buy/product-discovery/media-products#proposals)** - Structured media plans with budget allocations
- **[`get_products` Task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/get_products)** - Complete API reference