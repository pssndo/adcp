...
**Reference**: [`get_products` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/get_products)
...
**Reference**: [`list_creative_formats` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/list_creative_formats)
...
**Reference**: [`create_media_buy` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/create_media_buy)
...
**Reference**: [`update_media_buy` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/update_media_buy)
...
**Reference**: [`sync_catalogs` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/sync_catalogs)
...
**Reference**: [`list_creatives` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/list_creatives)
...
**Reference**: [`sync_creatives` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/sync_creatives)
...
**Reference**: [`get_media_buys` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/get_media_buys)
...
**Reference**: [`get_media_buy_delivery` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/get_media_buy_delivery)
...
**Reference**: [`provide_performance_feedback` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/provide_performance_feedback)
...
**Reference**: [`sync_event_sources` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/sync_event_sources)
...
**Reference**: [`log_event` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/log_event)
...
**Reference**: [`sync_audiences` task](/dist/docs/3.0.0-rc.1/media-buy/task-reference/sync_audiences)
...
Sales agents MUST return errors using the [standard AdCP error schema](/dist/docs/3.0.0-rc.1/building/implementation/error-handling).
