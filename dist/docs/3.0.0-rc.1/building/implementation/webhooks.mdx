...
See [Task Reference](/dist/docs/3.0.0-rc.1/media-buy/task-reference) for details on `reporting_webhook`.

## Next steps

- [Task Lifecycle](/dist/docs/3.0.0-rc.1/building/implementation/task-lifecycle) — status values and transitions
- [Async Operations](/dist/docs/3.0.0-rc.1/building/implementation/async-operations) — handling long-running tasks
- [Error Handling](/dist/docs/3.0.0-rc.1/building/implementation/error-handling) — webhook error patterns
