...
**Status:** Release Candidate | [AdCP v3 overview](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3)
...
**Status:** Beta | [AdCP v3 overview](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3)
...
4. **Commerce Media** - Catalog-driven product discovery (`catalog` on `get_products`), catalog-driven packages, per-catalog-item delivery reporting (`by_catalog_item`), store catchment targeting, and `catalog_types` on products. Cross-retailer GTIN matching via catalog selectors. Commerce attribution metrics (`roas`, `new_to_brand_rate`) in delivery response. See the [Commerce Media Guide](/dist/docs/3.0.0-rc.1/guides/commerce-media) and [Catalogs](/dist/docs/3.0.0-rc.1/creative/catalogs).
...
**Status:** Beta | [Full Changelog](https://github.com/adcontextprotocol/adcp/blob/main/CHANGELOG.md#300-beta2) | [AdCP v3 overview](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3)
...
**Status:** Beta | [Full Changelog](https://github.com/adcontextprotocol/adcp/blob/main/CHANGELOG.md#300-beta1) | [AdCP v3 overview](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3)
...
Version 3.0.0 is a **major release** that expands AdCP beyond media buying into governance, brand suitability, and conversational commerce. See the [AdCP v3 overview](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3) for detailed upgrade instructions.

**🎯 Key Themes:**

1. **Media Channel Taxonomy** - Complete overhaul from 9 format-oriented channels to 19 planning-oriented channels that reflect how buyers allocate budgets. See [Media Channel Taxonomy](/dist/docs/3.0.0-rc.1/reference/media-channel-taxonomy).
...
3. **Sponsored Intelligence Protocol** - Conversational brand experiences in AI assistants. Defines how hosts invoke brand agent endpoints for rich engagement without breaking conversational flow. See [Sponsored Intelligence](/dist/docs/3.0.0-rc.1/sponsored-intelligence/overview).
...
See [AdCP v3 overview](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3) for detailed before/after examples and migration steps.
...
See [Sponsored Intelligence Overview](/dist/docs/3.0.0-rc.1/sponsored-intelligence/overview) for complete documentation.
...
- [ ] Update channel enum values ([taxonomy guide](/dist/docs/3.0.0-rc.1/reference/media-channel-taxonomy))
...
**[View AdCP v3 overview →](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3)**
