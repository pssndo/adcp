...
**Related:** [Channels](/dist/docs/3.0.0-rc.1/reference/migration/channels) | [Pricing](/dist/docs/3.0.0-rc.1/reference/migration/pricing) | [Signals](/dist/docs/3.0.0-rc.1/reference/migration/signals) | [AdCP v3 overview](/dist/docs/3.0.0-rc.1/reference/whats-new-in-v3)
