...
| **[Brand Protocol](/dist/docs/3.0.0-rc.1/brand-protocol/index)** | Brand identity & agents | brand.json discovery, brand agent authorization |
...
| Brand Identity & Standards Library | Machine-readable brand policies | [Brand identity](/dist/docs/3.0.0-rc.1/brand-protocol/brand-json), Content Standards |
...
<CardGroup cols={2}>
  <Card title="Property Governance" icon="building" href="/dist/docs/3.0.0-rc.1/governance/property/index">
    Control where ads can run with property lists, compliance filtering, and publisher authorization via adagents.json.
  </Card>
  <Card title="Content Standards" icon="shield-check" href="/dist/docs/3.0.0-rc.1/governance/content-standards/index">
    Privacy-preserving brand suitability through calibration-based content evaluation and validation.
  </Card>
  <Card title="Creative Governance" icon="palette" href="/dist/docs/3.0.0-rc.1/governance/creative/index">
