...
```json
{
  "$schema": "/schemas/3.0.0-rc.1/content-standards/create-content-standards-request.json",
  "scope": {
...
```json
{
  "$schema": "/schemas/3.0.0-rc.1/content-standards/create-content-standards-response.json",
