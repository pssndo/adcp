...
- **[Testable Examples](/dist/docs/3.0.0-rc.2/media-buy/task-reference/get_products)** - Working code examples for all tasks
- **[Media Buy Lifecycle](/dist/docs/3.0.0-rc.2/media-buy/media-buys/)** - Full campaign workflow
- **[Building with AdCP](/dist/docs/3.0.0-rc.2/building/)** - MCP and A2A integration

## Need Help?

- Read the **[Introduction](/dist/docs/3.0.0-rc.2/intro)** for concepts
- Check **[Authentication](/dist/docs/3.0.0-rc.2/building/integration/authentication)** for production setup
...
[Learn more about authentication →](/dist/docs/3.0.0-rc.2/building/integration/authentication)
...
[Compare protocols →](/dist/docs/3.0.0-rc.2/building/understanding/protocol-comparison)

## Next Steps

- **[Media Buy Workflow](/dist/docs/3.0.0-rc.2/media-buy/)** - Create and manage campaigns
- **[Task Reference](/dist/docs/3.0.0-rc.2/media-buy/task-reference/)** - Complete API documentation
...
[See task reference →](/dist/docs/3.0.0-rc.2/media-buy/task-reference)
