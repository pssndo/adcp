...
*The Sponsored Intelligence Protocol is part of the broader [AdCP ecosystem](/dist/docs/3.0.0-rc.2/intro), enabling the next generation of AI-powered advertising.*
