...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/sponsored-intelligence/si-initiate-session-request.json",
...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/sponsored-intelligence/si-initiate-session-response.json",
