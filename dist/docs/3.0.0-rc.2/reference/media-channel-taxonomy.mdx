...
| `sponsored_intelligence` | AI assistants, AI search, and generative AI platforms |
...
**Note**: `sponsored_intelligence` describes the BUYING CONTEXT (AI platform ad tools) where the user is interacting with an AI system, not traditional web or app surfaces.
...
- Add `sponsored_intelligence` channel for AI platform advertising (AI assistants, AI search, generative AI experiences)
- 20 channels defined
