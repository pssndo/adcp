...
<Card title="Signals Protocol" icon="arrow-right" href="/dist/docs/3.0.0-rc.2/signals/overview">
  Full reference for signal discovery, activation, and pricing models.
</Card>

---

**Related:** [Brand identity](/dist/docs/3.0.0-rc.2/reference/migration/brand-identity) | [Optimization goals](/dist/docs/3.0.0-rc.2/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.0.0-rc.2/reference/whats-new-in-v3)
