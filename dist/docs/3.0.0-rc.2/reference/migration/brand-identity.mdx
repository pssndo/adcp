...
<Card title="Brand identity" icon="arrow-right" href="/dist/docs/3.0.0-rc.2/brand-protocol/brand-json">
  Full reference for brand.json variants, the brand registry, and BrandRef resolution.
</Card>

---

**Related:** [Channels](/dist/docs/3.0.0-rc.2/reference/migration/channels) | [Catalogs](/dist/docs/3.0.0-rc.2/reference/migration/catalogs) | [Brand Protocol](/dist/docs/3.0.0-rc.2/brand-protocol) | [AdCP 3.0 overview](/dist/docs/3.0.0-rc.2/reference/whats-new-in-v3)
