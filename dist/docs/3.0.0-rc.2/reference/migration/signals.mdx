...
**Related:** [Pricing](/dist/docs/3.0.0-rc.2/reference/migration/pricing) | [Optimization goals](/dist/docs/3.0.0-rc.2/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.0.0-rc.2/reference/whats-new-in-v3)
