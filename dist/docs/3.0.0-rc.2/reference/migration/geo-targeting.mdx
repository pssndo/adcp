...
<Card title="Targeting" icon="arrow-right" href="/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/targeting">
  Full targeting reference: audiences, contextual, geographic, and device targeting.
</Card>

---

**Related:** [Channels](/dist/docs/3.0.0-rc.2/reference/migration/channels) | [Pricing](/dist/docs/3.0.0-rc.2/reference/migration/pricing) | [Creatives](/dist/docs/3.0.0-rc.2/reference/migration/creatives) | [Catalogs](/dist/docs/3.0.0-rc.2/reference/migration/catalogs) | [Attribution](/dist/docs/3.0.0-rc.2/reference/migration/attribution) | [AdCP 3.0 overview](/dist/docs/3.0.0-rc.2/reference/whats-new-in-v3)
