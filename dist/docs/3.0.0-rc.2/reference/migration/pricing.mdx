...
<Card title="Media products" icon="arrow-right" href="/dist/docs/3.0.0-rc.2/media-buy/product-discovery/media-products">
  How products declare pricing options, channels, and capabilities.
</Card>

---

**Related:** [Channels](/dist/docs/3.0.0-rc.2/reference/migration/channels) | [Geo targeting](/dist/docs/3.0.0-rc.2/reference/migration/geo-targeting) | [Creatives](/dist/docs/3.0.0-rc.2/reference/migration/creatives) | [Catalogs](/dist/docs/3.0.0-rc.2/reference/migration/catalogs) | [Attribution](/dist/docs/3.0.0-rc.2/reference/migration/attribution) | [AdCP 3.0 overview](/dist/docs/3.0.0-rc.2/reference/whats-new-in-v3)
