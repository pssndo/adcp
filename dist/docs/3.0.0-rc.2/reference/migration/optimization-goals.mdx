...
**Related:** [Channels](/dist/docs/3.0.0-rc.2/reference/migration/channels) | [Pricing](/dist/docs/3.0.0-rc.2/reference/migration/pricing) | [Signals](/dist/docs/3.0.0-rc.2/reference/migration/signals) | [AdCP 3.0 overview](/dist/docs/3.0.0-rc.2/reference/whats-new-in-v3)
