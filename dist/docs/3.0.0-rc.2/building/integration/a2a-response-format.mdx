...
Extract AdCP data using the same last-DataPart pattern. **For webhook authentication, retry patterns, and security**, see [Webhooks](/dist/docs/3.0.0-rc.2/building/implementation/webhooks).
...
- [A2A Guide](/dist/docs/3.0.0-rc.2/building/integration/a2a-guide) - Complete A2A integration guide
- [Task Lifecycle](/dist/docs/3.0.0-rc.2/building/implementation/task-lifecycle) - Status handling patterns
- [Error Handling](/dist/docs/3.0.0-rc.2/building/implementation/error-handling) - Fatal vs non-fatal errors
- [Protocol Comparison](/dist/docs/3.0.0-rc.2/building/understanding/protocol-comparison) - MCP vs A2A differences
