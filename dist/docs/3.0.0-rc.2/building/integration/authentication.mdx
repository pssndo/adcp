...
An agent may have access to multiple accounts (e.g., an agency managing several clients). See [Accounts and Agents](/dist/docs/3.0.0-rc.2/building/integration/accounts-and-agents) for details on account selection and billing attribution.
...
See [Sandbox Mode](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/sandbox) for testing capabilities including sandbox mode for risk-free development.