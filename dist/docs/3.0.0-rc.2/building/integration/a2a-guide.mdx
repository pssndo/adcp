...
Transport-specific guide for integrating AdCP using the Agent-to-Agent Protocol. For task handling, status management, and workflow patterns, see [Task Lifecycle](/dist/docs/3.0.0-rc.2/building/implementation/task-lifecycle).
...
**Status Handling**: See [Task Lifecycle](/dist/docs/3.0.0-rc.2/building/implementation/task-lifecycle) for complete status handling patterns.
...
**For complete canonical format specification, see [A2A Response Format](/dist/docs/3.0.0-rc.2/building/integration/a2a-response-format).**
...
**For complete response structure requirements, error handling, and implementation patterns, see [A2A Response Format](/dist/docs/3.0.0-rc.2/building/integration/a2a-response-format).**
...
For webhook payload formats, protocol comparison, and detailed handling examples, see [Webhooks](/dist/docs/3.0.0-rc.2/building/implementation/webhooks).
...
**Task Management**: For comprehensive guidance on tracking async operations across all domains, polling patterns, and webhook integration, see [Webhooks](/dist/docs/3.0.0-rc.2/building/implementation/webhooks).
...
**Task Parameters**: See [Media Buy](/dist/docs/3.0.0-rc.2/media-buy) and [Signals](/dist/docs/3.0.0-rc.2/signals/overview) documentation for complete parameter specifications.
...
<Note>
**Recommended**: Use [`get_adcp_capabilities`](/dist/docs/3.0.0-rc.2/protocol/get_adcp_capabilities) for runtime capability discovery. The agent card extension provides static metadata for agent registries and discovery services.
</Note>
...
For uploading creative assets and handling validation errors, use the `sync_creatives` task. See [sync_creatives Task Reference](/dist/docs/3.0.0-rc.2/creative/task-reference/sync_creatives) for complete testable examples.
...
- **Core Concepts**: Read [Task Lifecycle](/dist/docs/3.0.0-rc.2/building/implementation/task-lifecycle) for status handling and workflows  
- **Task Reference**: See [Media Buy Tasks](/dist/docs/3.0.0-rc.2/media-buy) and [Signals](/dist/docs/3.0.0-rc.2/signals/overview)
- **Protocol Comparison**: Compare with [MCP integration](/dist/docs/3.0.0-rc.2/building/integration/mcp-guide)
- **Examples**: Find complete workflow examples in Core Concepts

**For status handling, async operations, and clarification patterns, see [Task Lifecycle](/dist/docs/3.0.0-rc.2/building/implementation/task-lifecycle) - this guide focuses on A2A transport specifics only.**