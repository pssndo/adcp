...
- [Quickstart Guide](/dist/docs/3.0.0-rc.2/quickstart)
...
Check [Release Notes](/dist/docs/3.0.0-rc.2/reference/release-notes) for version history and migration guides.
...
<Card title="Registry API Reference" icon="server" href="/dist/docs/3.0.0-rc.2/registry/index">
