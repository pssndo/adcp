...
See [Task Lifecycle](/dist/docs/3.0.0-rc.2/building/implementation/task-lifecycle) for complete status handling guide.
...
- **MCP Guide**: See [MCP Guide](/dist/docs/3.0.0-rc.2/building/integration/mcp-guide) for tool calls and context management
- **A2A Guide**: See [A2A Guide](/dist/docs/3.0.0-rc.2/building/integration/a2a-guide) for artifacts and streaming
