...
- [Brief Expectations](/dist/docs/3.0.0-rc.2/media-buy/product-discovery/brief-expectations) - How publishers process briefs
- [Creative Formats](/dist/docs/3.0.0-rc.2/creative/formats) - Understanding format specifications and discovery
- [Media Buy Lifecycle](/dist/docs/3.0.0-rc.2/media-buy/media-buys) - Campaign execution workflow
- [Product Discovery](/dist/docs/3.0.0-rc.2/media-buy/product-discovery) - How briefs influence product selection