...
The [Media Buy Specification](/dist/docs/3.0.0-rc.2/media-buy/specification#get_products) defines the following normative requirements for refinement:
...
- [`get_products` task reference](/dist/docs/3.0.0-rc.2/media-buy/task-reference/get_products#refinement) — API reference with request/response schemas
- [Media Products](/dist/docs/3.0.0-rc.2/media-buy/product-discovery/media-products) — product model and proposal structure
- [Media Buy Specification](/dist/docs/3.0.0-rc.2/media-buy/specification#get_products) — normative requirements
- [Orchestrator Design](/dist/docs/3.0.0-rc.2/building/implementation/orchestrator-design) — building buyer-side agents
