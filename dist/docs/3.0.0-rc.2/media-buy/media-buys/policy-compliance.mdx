...
For comprehensive guidance on briefs and brand information, see [Brief Expectations](/dist/docs/3.0.0-rc.2/media-buy/product-discovery/brief-expectations).
...
- [`get_products`](/dist/docs/3.0.0-rc.2/media-buy/task-reference/get_products) - Product discovery with policy checks
- [`create_media_buy`](/dist/docs/3.0.0-rc.2/media-buy/task-reference/create_media_buy) - Media buy creation with validation
- [Accounts & Security](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/accounts-and-security) - Authentication and authorization
