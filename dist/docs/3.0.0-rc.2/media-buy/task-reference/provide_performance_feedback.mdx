...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/media-buy/provide-performance-feedback-request.json",
  "media_buy_id": "gam_1234567890",
  "measurement_period": {
...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/media-buy/provide-performance-feedback-response.json",
  "success": true,
...
- [`get_media_buy_delivery`](/dist/docs/3.0.0-rc.2/media-buy/task-reference/get_media_buy_delivery) - Retrieve delivery metrics
- [Optimization & Reporting](/dist/docs/3.0.0-rc.2/media-buy/media-buys/optimization-reporting) - Performance feedback concepts
- [Targeting](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/targeting) - Understanding targeting for optimization