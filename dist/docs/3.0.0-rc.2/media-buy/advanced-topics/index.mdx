...
- **[Targeting](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/targeting)** - Brief-based targeting with geographic overlays and real-time signals
- **[Agentic eXecution Engine (AXE)](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/agentic-execution-engine)** - Real-time execution layer for dynamic audience targeting, brand suitability, and frequency management
...
- **[Accounts & Security](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/accounts-and-security)** - Multi-tenant security model and access control
...
- **[Orchestrator Design](/dist/docs/3.0.0-rc.2/building/implementation/orchestrator-design)** - Technical architecture for AdCP orchestrators
...
- **[Sandbox Mode](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/sandbox)** - Run operations without real platform calls or spend
...
- **Review [Sandbox Mode](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/sandbox)** for development best practices
- **Explore [Orchestrator Design](/dist/docs/3.0.0-rc.2/building/implementation/orchestrator-design)** for architecture guidance