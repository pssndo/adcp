...
The `axe_integrations` URL in a seller's [`get_adcp_capabilities`](/dist/docs/3.0.0-rc.2/protocol/get_adcp_capabilities) response tells buyers which orchestrator's AXE endpoint the seller connects to:
...
See [Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) for details.
...
- **[Targeting](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/targeting)** - Brief-based targeting and geographic overlays
- **[Signals Protocol](/dist/docs/3.0.0-rc.2/signals/overview)** - Signal discovery and activation
- **[Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros)** - Creative-level AXE integration
- **[Orchestrator Design](/dist/docs/3.0.0-rc.2/building/implementation/orchestrator-design)** - Building orchestration platforms
