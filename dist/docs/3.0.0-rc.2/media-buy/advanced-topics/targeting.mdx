...
For targeting decisions that must happen at impression time, buyers can use the **[Agentic eXecution Engine (AXE)](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/agentic-execution-engine)**. AXE is the real-time execution layer between orchestrators and decisioning platforms.
...
See the [AXE documentation](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/agentic-execution-engine) for implementation details.
...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/core/targeting.json",
  "age_restriction": {
    "min": 21,
...
- **Details**: See [AXE documentation](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/agentic-execution-engine)
...
- **Format**: Array of `audience_id` strings from [`sync_audiences`](/dist/docs/3.0.0-rc.2/media-buy/task-reference/sync_audiences)
...
Real-time signals are provided through the [AdCP Signals Protocol](/dist/docs/3.0.0-rc.2/signals/overview), which allows orchestrators to supply targeting data at impression time.
...
- **[Agentic eXecution Engine (AXE)](/dist/docs/3.0.0-rc.2/media-buy/advanced-topics/agentic-execution-engine)** - Real-time execution layer for dynamic targeting
- **[Signals Protocol](/dist/docs/3.0.0-rc.2/signals/overview)** - Real-time targeting signals for brand suitability and contextual targeting
- **[Product Discovery](/dist/docs/3.0.0-rc.2/media-buy/product-discovery/)** - How briefs lead to targeted product recommendations
- **[Example Briefs](/dist/docs/3.0.0-rc.2/media-buy/product-discovery/example-briefs)** - Real examples of effective targeting briefs
- **[Policy Compliance](/dist/docs/3.0.0-rc.2/media-buy/media-buys/policy-compliance)** - Automated compliance checking and enforcement
