...
- [list_accounts](/dist/docs/3.0.0-rc.2/accounts/tasks/list_accounts) -- Poll for status changes on pending accounts
...
- [get_adcp_capabilities](/dist/docs/3.0.0-rc.2/protocol/get_adcp_capabilities) -- Discover `supported_billing` and `require_operator_auth` before syncing accounts
