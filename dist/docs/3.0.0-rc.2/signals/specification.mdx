...
**Reference**: [`get_signals` task](/dist/docs/3.0.0-rc.2/signals/tasks/get_signals)
...
**Reference**: [`activate_signal` task](/dist/docs/3.0.0-rc.2/signals/tasks/activate_signal)
...
Signal agents MUST return errors using the [standard AdCP error schema](/dist/docs/3.0.0-rc.2/building/implementation/error-handling).

Signal agents MUST use Signals Protocol error codes as defined in the [Error Handling Reference](/dist/docs/3.0.0-rc.2/building/implementation/error-handling).
