...
| [Brand enrichment](/dist/docs/3.0.0-rc.2/registry/index#brand-resolution) | Fetches from Brandfetch, saves identity to registry | No `brand.json` available, need enrichment |
| [Registry lookup](/dist/docs/3.0.0-rc.2/registry/index#brand-resolution) | Returns community or enriched identity from the registry | Brand already registered |
...
<CardGroup cols={2}>
  ...
  <Card title="get_brand_identity" icon="id-card" href="/dist/docs/3.0.0-rc.2/brand-protocol/tasks/get_brand_identity">
