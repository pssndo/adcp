...
OpenRTB and AdCP are complementary. OpenRTB handles "should I bid on this impression?"; AdCP handles "create a campaign with this budget and targeting." See [AdCP and OpenRTB](/dist/docs/3.0.0-rc.2/building/understanding/adcp-vs-openrtb) for details.
...
<CardGroup cols={2}>
  <Card title="Introduction to AdCP" icon="book" href="/dist/docs/3.0.0-rc.2/intro">
  ...
  <Card title="AdCP and OpenRTB" icon="arrows-left-right" href="/dist/docs/3.0.0-rc.2/building/understanding/adcp-vs-openrtb">
