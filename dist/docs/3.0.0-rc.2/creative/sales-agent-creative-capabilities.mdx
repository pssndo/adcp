...
- [get_creative_delivery](/dist/docs/3.0.0-rc.2/creative/task-reference/get_creative_delivery) — Variant-level delivery reporting
- [get_media_buy_delivery](/dist/docs/3.0.0-rc.2/media-buy/task-reference/get_media_buy_delivery) — Media buy delivery reporting
