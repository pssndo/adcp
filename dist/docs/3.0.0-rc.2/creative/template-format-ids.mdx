...
- [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) - Complete manifest structure
- [Format Discovery](/dist/docs/3.0.0-rc.2/creative/formats) - How buyers discover formats
- [Placement Targeting](/dist/docs/3.0.0-rc.2/media-buy/creatives) - Assigning creatives to placements
