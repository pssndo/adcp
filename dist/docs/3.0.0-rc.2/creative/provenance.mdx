...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/core/provenance.json",
...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/content-standards/artifact.json",
...
These results are **supplementary**. A seller that requires provenance verification runs its own detection through [`get_creative_features`](/dist/docs/3.0.0-rc.2/governance/creative/get_creative_features) rather than trusting the buyer's attached results.
...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/core/creative-policy.json",
...
- [Provenance verification](/dist/docs/3.0.0-rc.2/governance/creative/provenance-verification) -- How the governance infrastructure verifies AI provenance claims
- [Creative Governance](/dist/docs/3.0.0-rc.2/governance/creative/index) -- Feature-based creative evaluation via `get_creative_features`
- [Content Standards](/dist/docs/3.0.0-rc.2/governance/content-standards/index) -- Privacy-preserving brand suitability for publisher content
- [Generative Creative](/dist/docs/3.0.0-rc.2/creative/generative-creative) -- AI-powered creative generation with `build_creative`
