...
In addition to [universal macros](/dist/docs/3.0.0-rc.2/creative/universal-macros), some platforms support carousel-specific macros:
...
- [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) - Complete manifest specification
- [Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) - Supported macros for tracking
- [Asset Types](/dist/docs/3.0.0-rc.2/creative/asset-types) - Asset type specifications
- [Display Ads](/dist/docs/3.0.0-rc.2/creative/channels/display) - Standard display formats
- [Video Ads](/dist/docs/3.0.0-rc.2/creative/channels/video) - Video format specifications
