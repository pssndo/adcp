...
In addition to [universal macros](/dist/docs/3.0.0-rc.2/creative/universal-macros), DOOH formats support:
...
- [Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) - Complete macro reference including DOOH macros
- [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) - Manifest structure and examples
- [Asset Types](/dist/docs/3.0.0-rc.2/creative/asset-types) - URL asset specifications
