...
See [Creative review](/dist/docs/3.0.0-rc.2/creative/sales-agent-creative-capabilities#creative-review) for the full review flow.
...
See [Carousels](/dist/docs/3.0.0-rc.2/creative/channels/carousels) for carousel-specific guidance on card ordering, aspect ratios, and swipe behavior.
...
- [Implementing creative agents — Pattern 4: feed-native](/dist/docs/3.0.0-rc.2/creative/implementing-creative-agents#pattern-4-feed-nativesocial-format-agent) — Implementation guide for feed-native format agents
- [Carousels](/dist/docs/3.0.0-rc.2/creative/channels/carousels) — Multi-card format specifications
- [Creative review](/dist/docs/3.0.0-rc.2/creative/sales-agent-creative-capabilities#creative-review) — Approval flow including community guidelines
