...
- [Video ads](/dist/docs/3.0.0-rc.2/creative/channels/video) -- Video format specs, codecs, and encoding details
- [Display ads](/dist/docs/3.0.0-rc.2/creative/channels/display) -- Companion banner format patterns
- [Multi-agent creative orchestration](/dist/docs/3.0.0-rc.2/creative/multi-agent-orchestration) -- Distributing CTV creatives across multiple sellers
- [Universal macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) -- Complete macro reference including CTV-specific macros
- [Creative manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) -- Manifest structure and asset specifications
