...
In addition to [universal macros](/dist/docs/3.0.0-rc.2/creative/universal-macros), audio formats support:
...
- [Asset Types](/dist/docs/3.0.0-rc.2/creative/asset-types) - Audio asset specifications
