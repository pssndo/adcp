...
In addition to [universal macros](/dist/docs/3.0.0-rc.2/creative/universal-macros), video formats support:
...
- [Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) - Complete macro reference including video macros
- [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) - Manifest structure and asset specifications
- [Asset Types](/dist/docs/3.0.0-rc.2/creative/asset-types) - Video asset type definitions
