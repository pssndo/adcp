...
In addition to [universal macros](/dist/docs/3.0.0-rc.2/creative/universal-macros), display formats support:
...
- [Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) - Complete macro reference
- [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) - Manifest structure and validation
- [Asset Types](/dist/docs/3.0.0-rc.2/creative/asset-types) - Image, HTML, and JavaScript asset specifications
