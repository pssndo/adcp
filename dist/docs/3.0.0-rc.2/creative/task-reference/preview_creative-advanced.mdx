...
For basic usage, see [preview_creative](/dist/docs/3.0.0-rc.2/creative/task-reference/preview_creative).
...
- [preview_creative](/dist/docs/3.0.0-rc.2/creative/task-reference/preview_creative) - Basic usage and parameters
- [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) - Manifest structure
- [Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) - Available macro values
