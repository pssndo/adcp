...
- [Creative Formats](/dist/docs/3.0.0-rc.2/creative/formats) — Format structure and requirements
- [Asset Types](/dist/docs/3.0.0-rc.2/creative/asset-types) — Asset specifications and payload schemas
- [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) — Pairing assets with formats
- [list_creative_formats](/dist/docs/3.0.0-rc.2/creative/task-reference/list_creative_formats) — Format discovery with filtering
