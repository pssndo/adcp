...
See [Creative Formats](/dist/docs/3.0.0-rc.2/creative/formats) for format discovery details.
...
See [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) for manifest structure details.
...
See [Asset Types](/dist/docs/3.0.0-rc.2/creative/asset-types) for detailed specifications.
...
See the [Channel Guides](/dist/docs/3.0.0-rc.2/creative/channels/video) for format examples and patterns across video, display, audio, DOOH, and carousels.
...
See [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests) for detailed documentation.
...
See [Universal Macros](/dist/docs/3.0.0-rc.2/creative/universal-macros) for complete reference.
...
This pattern is most commonly used with Display formats. See the [Display Channel Guide](/dist/docs/3.0.0-rc.2/creative/channels/display) for third-party tag examples.
...
See the [Carousel & Multi-Asset Formats](/dist/docs/3.0.0-rc.2/creative/channels/carousels) guide for detailed documentation.
...
This affects measurement and reporting only and does not change creative format classification or asset requirements. See the [DOOH Channel Guide](/dist/docs/3.0.0-rc.2/creative/channels/dooh) for DOOH-specific macro details.

## Channel-Specific Information

For detailed information on creatives by channel and format family, see [Creative Manifests](/dist/docs/3.0.0-rc.2/creative/creative-manifests), including:
...
- [Creative Task Reference](/dist/docs/3.0.0-rc.2/creative/task-reference/list_creative_formats) - API documentation for creative tasks
- [Generative Creative](/dist/docs/3.0.0-rc.2/creative/generative-creative) - AI-powered creative generation guide
