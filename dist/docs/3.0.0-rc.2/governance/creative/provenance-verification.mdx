...
- [AI provenance and disclosure](/dist/docs/3.0.0-rc.2/creative/provenance) -- The provenance schema reference, digital source type enum, and inheritance model
...
- [`get_creative_features`](/dist/docs/3.0.0-rc.2/governance/creative/get_creative_features) -- Task reference for creative feature evaluation
...
- [`calibrate_content`](/dist/docs/3.0.0-rc.2/governance/content-standards/tasks/calibrate_content) -- Calibration task for content standards alignment
- [`validate_content_delivery`](/dist/docs/3.0.0-rc.2/governance/content-standards/tasks/validate_content_delivery) -- Post-delivery content validation
