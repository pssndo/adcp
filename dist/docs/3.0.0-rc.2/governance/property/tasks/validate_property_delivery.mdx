...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/property/validate-property-delivery-request.json",
  "list_id": "pl_abc123",
  "records": [
    {
...
```json
{
  "$schema": "/schemas/3.0.0-rc.2/property/validate-property-delivery-response.json",
  "list_id": "pl_abc123",
  "summary": {
    "total_records": 4,
...
- [get_adcp_capabilities](/dist/docs/3.0.0-rc.2/protocol/get_adcp_capabilities) - Discover available filter features
