...
:::note MCP transport
If you're using MCP, long-running operations are handled via [MCP Tasks](https://modelcontextprotocol.io/specification/2025-11-25/basic/utilities/tasks) — the client manages polling at the protocol level, outside the LLM loop. See [MCP Guide](/docs/building/integration/mcp-guide#async-operations-via-mcp-tasks). The patterns below apply to REST integrations and generic orchestrators.
:::
