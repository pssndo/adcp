...
5. **Campaign governance lifecycle** — Sync governance agents via `sync_governance`, create a campaign plan, validate actions (proposed + committed), handle denials and conditions, report outcomes, and review audit logs
