...
rc.2 added brand-side capabilities (rights licensing, visual guidelines) and content modeling (collections and installments) based on working group feedback.
